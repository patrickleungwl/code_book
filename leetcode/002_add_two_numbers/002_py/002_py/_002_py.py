...
class Solution:
    def addTwoNumbers(self, l1: ListNode, l2: ListNode) -> ListNode:
        ...
        while l1 != None or l2 != None or carry>0:
            left_val = 0
            right_val = 0
            if l1 != None: left_val = l1.val
            if l2 != None: right_val = l2.val
...
class TestNode(ut.TestCase):
    ...
    def test_ListNodeGenerator_GenerateExpectedNodeList(self):
        ...
        self.assertEqual(returned_list, numbers_list)


    def test_Solution_AddTwoNumbers(self):
        g = ListNodeGenerator()
        nlOne = g.buildListNode([2,4,3])
        nlTwo = g.buildListNode([5,6,4])
        s = Solution()
        result = s.addTwoNumbers(nlOne, nlTwo)
        self.assertEqual([7,0,8], g.convertToList(result))


    def test_Solution_AddOneNull(self):
        g = ListNodeGenerator()
        nlOne = g.buildListNode([])
        nlTwo = g.buildListNode([0,1])
        s = Solution()
        result = s.addTwoNumbers(nlOne, nlTwo)
        self.assertEqual([], g.convertToList(result))
    ...
    def test_Solution_AddTwoNumbersUnevenSizes(self):
        g = ListNodeGenerator()
        nlOne = g.buildListNode([0,1])
        nlTwo = g.buildListNode([0,1,2])
        s = Solution()
        result = s.addTwoNumbers(nlOne, nlTwo)
        self.assertEqual([0,2,2], g.convertToList(result))


    def test_Solution_AddTwoZeros(self):
        g = ListNodeGenerator()
        nlOne = g.buildListNode([0])
        nlTwo = g.buildListNode([0])
        s = Solution()
        result = s.addTwoNumbers(nlOne, nlTwo)
        self.assertEqual([0], g.convertToList(result))
    ...
    def test_Solution_AddOneNull(self):
        ...
        s = Solution()
        result = s.addTwoNumbers(nlOne, nlTwo)
        self.assertEqual([0,0,1], g.convertToList(result))
    ...
    def test_Solution_AddTwoZeros(self):
        ...
        s = Solution()
        result = s.addTwoNumbers(nlOne, nlTwo)
        self.assertEqual([8,9,9,9,0,0,0,1], g.convertToList(result))
